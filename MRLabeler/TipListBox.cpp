// TipListBox.cpp : implementation file
//
...
BEGIN_MESSAGE_MAP(CTipListBox, CListBox)
	//{{AFX_MSG_MAP(CTipListBox)
...
/////////////////////////////////////////////////////////////////////////////
// CTipListBox message handlers

void CTipListBox::PreSubclassWindow() 
{
	CListBox::PreSubclassWindow();
	EnableToolTips(TRUE);
}

INT_PTR CTipListBox::OnToolHitTest(CPoint point, TOOLINFO * pTI) const
{
	int row;
...
BOOL CTipListBox::OnToolTipText( UINT id, NMHDR * pNMHDR, LRESULT * pResult )
{
...
UINT CTipListBox::ItemFromPoint2(CPoint pt, BOOL& bOutside) const
